...
/**
 * Four megabytes is enormous for the job — a minute of Opus is around 120 KB
 * before base64. The ceiling is here so an unbounded upload cannot be pointed
 * at a paid API, not because anyone will approach it. It used to sit under a
 * 4.5 MB platform body limit as well; that limit is gone, this guard is not.
 */
