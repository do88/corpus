        ...
        text={
          summary.loggedDays > 0
            ? {
                ...
                fiber_g:
                  summary.average.fiber_g == null
                    ? { lead: "—", detail: "no day has fibre for every meal yet" }
                    : {
                        lead: `${summary.average.fiber_g}g a day`,
                        detail: `over ${summary.fibreDays} of ${summary.loggedDays} days · target ${targets.fiber_g} g`,
                      },
